...
privileged aspect Form_Roo_SolrSearch {
    ...
    public static void Form.indexForms(Collection<Form> forms) {
        ...
        for (Form form : forms) {
            ...
            sid.addField("form.operatorid_i", form.getOperatorId());
            sid.addField("form.operatornotes_s", form.getOperatorNotes());
            sid.addField("form.filldate_dt", form.getFillDate());
            // Add summary field to allow searching documents for objects of this type
            sid.addField("form_solrsummary_t", new StringBuilder().append(form.getInstanceId()).append(" ").append(form.getOrderInInstance()).append(" ").append(form.getOperatorId()).append(" ").append(form.getOperatorNotes()).append(" ").append(form.getFillDate()));
            documents.add(sid);
        }
        try {
