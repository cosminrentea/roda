...
public class PhoneController {
    ...
    public String create(@Valid Phone phone, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
    ...
    public String update(@Valid Phone phone, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
        if (bindingResult.hasErrors()) {
            populateEditForm(uiModel, phone);
	...
	void populateEditForm(Model uiModel, Phone phone) {
