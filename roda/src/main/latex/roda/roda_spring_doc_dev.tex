...
\item [STS =] Spring Tool Suite 3.3.0.RELEASE - based on Eclipse Juno 3.8.2
\item [Maven =] Maven 3
...
\end{itemize}
%TODO start/stop Solr + Postgresql
...
Pentru generarea documentatiei JavaDoc a proiectului:
\begin{lstlisting}
	mvn javadoc:javadoc
\end{lstlisting}

Pentru generarea documentatiei proiectului in format PDF (din surse LaTeX):
\begin{lstlisting}
	mvn latex:latex
\end{lstlisting}

Pentru generarea site-ului proiectului in format HTML (cuprinzand JavaDoc, informatii si rapoarte):
\begin{lstlisting}
	mvn site
\end{lstlisting}

\section{Web Development}
Se instaleaza Mozilla Firefox; in Firefox se instaleaza:
\begin{description}
\item [Firebug]
\item [Selenium IDE]
\end{description}
...
%TODO use 'Long-Term Support Release' ! 
% using now : 'Release', 'Latest&Greatest'
