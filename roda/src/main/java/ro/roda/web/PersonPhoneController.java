...
public class PersonPhoneController {
	...
	public String create(@Valid PersonPhone personPhone, BindingResult bindingResult, Model uiModel,
		...
		return "redirect:/personphones/"
				+ encodeUrlPathSegment(conversionService.convert(personPhone.getId(), String.class), httpServletRequest);
	}
	...
	public String update(@Valid PersonPhone personPhone, BindingResult bindingResult, Model uiModel,
			HttpServletRequest httpServletRequest) {
		if (bindingResult.hasErrors()) {
			populateEditForm(uiModel, personPhone);
	...
	public String delete(@PathVariable("id") PersonPhonePK id,
