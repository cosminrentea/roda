...
Folosind pentru conectarea la serverul Postgresql, in shell:
\begin{lstlisting}
	psql -h localhost
\end{lstlisting}
se dau apoi comenzile pentru crearea utilizatorului si a bazei de date ce vor fi folosite de aplicatie:
\begin{lstlisting}
