...
/**
 * <p>
 * Java class for invalrngType complex type.
 * 
 * <p>
...
@XmlType(name = "invalrngType", propOrder = { "range", "item" })
@Entity
@Table(schema = "ddi",name = "InvalidValueRange")
public class InvalrngType {
	...
	// TODO Cosmin a modificat urmatorul rand (comentat)
	// si l-a inlocuit cu 2 "List"-e noi, OneToMany
	// continand mai multe RangeType, respectiv ItemType
	// @XmlElements({
	...
	@OneToMany(cascade = { CascadeType.ALL }, mappedBy = "invalrngtype")
