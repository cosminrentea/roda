...
public class SeriesController {
    ...
    public String create(@Valid Series series, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
    ...
    public String update(@Valid Series series, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
        if (bindingResult.hasErrors()) {
            populateEditForm(uiModel, series);
    ...
    public String delete(@PathVariable("catalogId") Integer catalogId, @RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model uiModel) {
        Series series = seriesService.findSeries(catalogId);
        seriesService.deleteSeries(series);
        uiModel.asMap().clear();
