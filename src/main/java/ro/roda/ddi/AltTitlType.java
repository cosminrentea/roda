...
/**
 * <p>
 * Java class for altTitlType complex type.
 * 
 * <p>
...
@XmlType(name = "altTitlType")
@Entity
@Table(schema = "ddi",name = "AlternativeTitle")
public class AltTitlType {
	@Id
