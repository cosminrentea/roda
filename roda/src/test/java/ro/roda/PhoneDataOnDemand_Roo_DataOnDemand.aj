...
privileged aspect PhoneDataOnDemand_Roo_DataOnDemand {
    ...
    public Phone PhoneDataOnDemand.getNewTransientPhone(int index) {
        Phone obj = new Phone();
        setPhone(obj, index);
        setPhoneType(obj, index);
        return obj;
    }
    
    public void PhoneDataOnDemand.setPhone(Phone obj, int index) {
    ...
    public void PhoneDataOnDemand.setPhoneType(Phone obj, int index) {
        String phoneType = "phoneType_" + index;
        if (phoneType.length() > 50) {
            phoneType = phoneType.substring(0, 50);
        }
