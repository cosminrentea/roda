...
public class TimeMethTypeController {
    ...
    public String create(@Valid TimeMethType timeMethType, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
    ...
    public String update(@Valid TimeMethType timeMethType, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
        if (bindingResult.hasErrors()) {
            populateEditForm(uiModel, timeMethType);
