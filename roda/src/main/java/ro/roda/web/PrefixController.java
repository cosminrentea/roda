...
public class PrefixController {
	...
	public String create(@Valid Prefix prefix, BindingResult bindingResult, Model uiModel,
	...
	public String update(@Valid Prefix prefix, BindingResult bindingResult, Model uiModel,
			HttpServletRequest httpServletRequest) {
		if (bindingResult.hasErrors()) {
			populateEditForm(uiModel, prefix);
