...
/**
 * <p>
 * Java class for catValuType complex type.
 * 
 * <p>
...
@XmlType(name = "catValuType")
@Entity
@Table(schema = "ddi",name = "CategoryValue")
public class CatValuType {
	@Id
