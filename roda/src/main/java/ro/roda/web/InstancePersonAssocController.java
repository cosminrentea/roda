...
public class InstancePersonAssocController {
	...
	public String create(@Valid InstancePersonAssoc instancePersonAssoc, BindingResult bindingResult, Model uiModel,
		...
		return "redirect:/instancepersonassocs/"
				+ encodeUrlPathSegment(instancePersonAssoc.getId().toString(), httpServletRequest);
	}
	...
	public String list(@RequestParam(value = "page", required = false) Integer page,
		...
		if (page != null || size != null) {
			...
			uiModel.addAttribute("instancepersonassocs",
					instancePersonAssocService.findInstancePersonAssocEntries(firstResult, sizeNo));
	...
	public String update(@Valid InstancePersonAssoc instancePersonAssoc, BindingResult bindingResult, Model uiModel,
			HttpServletRequest httpServletRequest) {
		if (bindingResult.hasErrors()) {
			populateEditForm(uiModel, instancePersonAssoc);
	...
	void populateEditForm(Model uiModel, InstancePersonAssoc instancePersonAssoc) {
