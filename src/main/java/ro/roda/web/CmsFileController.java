...
//		return "redirect:/files/" + encodeUrlPathSegment(cmsFile.getId().toString(), httpServletRequest);
	...
	public String create(@Valid CmsFile cmsFile, BindingResult bindingResult, Model uiModel,
	...
	public String update(@Valid CmsFile cmsFile, BindingResult bindingResult, Model uiModel,
			HttpServletRequest httpServletRequest) {
		if (bindingResult.hasErrors()) {
			populateEditForm(uiModel, cmsFile);
