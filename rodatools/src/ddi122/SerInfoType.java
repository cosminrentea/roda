...
/**
 * <p>
 * Java class for serInfoType complex type.
 * 
 * <p>
...
@XmlType(name = "serInfoType", propOrder = { "content" })
@Entity
@Table(name = "SeriesInformation")
public class SerInfoType {
	@Id
	...
	@ManyToOne
	@JoinColumn(name = "serstmttype_id")
	@XmlTransient
	private SerStmtType serstmttype;

	public SerStmtType getSerstmttype() {
		return serstmttype;
	}

	public void setSerstmttype(SerStmtType serstmttype) {
		this.serstmttype = serstmttype;
	}
