...
public class SamplingProcedureController {
    ...
    public String create(@Valid SamplingProcedure samplingProcedure, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
    ...
    public String update(@Valid SamplingProcedure samplingProcedure, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
        if (bindingResult.hasErrors()) {
            populateEditForm(uiModel, samplingProcedure);
