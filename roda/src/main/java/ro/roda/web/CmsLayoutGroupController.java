...
public class CmsLayoutGroupController {
    ...
    public String create(@Valid CmsLayoutGroup cmsLayoutGroup, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
    ...
    public String update(@Valid CmsLayoutGroup cmsLayoutGroup, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
        if (bindingResult.hasErrors()) {
            populateEditForm(uiModel, cmsLayoutGroup);
