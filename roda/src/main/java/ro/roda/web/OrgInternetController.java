...
public class OrgInternetController {
	...
	public String create(@Valid OrgInternet orgInternet, BindingResult bindingResult, Model uiModel,
		...
		return "redirect:/orginternets/"
				+ encodeUrlPathSegment(conversionService.convert(orgInternet.getId(), String.class), httpServletRequest);
	}
	...
	public String update(@Valid OrgInternet orgInternet, BindingResult bindingResult, Model uiModel,
			HttpServletRequest httpServletRequest) {
		if (bindingResult.hasErrors()) {
			populateEditForm(uiModel, orgInternet);
	...
	public String delete(@PathVariable("id") OrgInternetPK id,
