...
public class Form {
    ...
    public static void indexForms(Collection<Form> forms) {
        ...
        for (Form form : forms) {
            ...
            sid.addField("form_solrsummary_t", new StringBuilder().append(form.getOperatorId()).append(" ").append(form.getOperatorNotes()).append(" ").append(form.getFormFilledAt().getTime()));
            documents.add(sid);
        }
        try {
