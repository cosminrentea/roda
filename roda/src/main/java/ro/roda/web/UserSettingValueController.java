...
public class UserSettingValueController {
    ...
    public String create(@Valid UserSettingValue userSettingValue, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
    ...
    public String update(@Valid UserSettingValue userSettingValue, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
        if (bindingResult.hasErrors()) {
            populateEditForm(uiModel, userSettingValue);
    ...
    public String delete(@PathVariable("id") UserSettingValuePK id, @RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model uiModel) {
        UserSettingValue userSettingValue = userSettingValueService.findUserSettingValue(id);
        userSettingValueService.deleteUserSettingValue(userSettingValue);
        uiModel.asMap().clear();
