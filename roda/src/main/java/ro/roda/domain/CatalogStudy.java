...
public class CatalogStudy {
    ...
    public static void indexCatalogStudys(Collection<CatalogStudy> catalogstudys) {
        ...
        for (CatalogStudy catalogStudy : catalogstudys) {
            ...
            sid.addField("catalogstudy_solrsummary_t", new StringBuilder().append(catalogStudy.getCatalogId()).append(" ").append(catalogStudy.getStudyId()).append(" ").append(catalogStudy.getAdded().getTime()).append(" ").append(catalogStudy.getId()));
            documents.add(sid);
        }
        try {
