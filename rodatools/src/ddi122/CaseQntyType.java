...
/**
 * <p>
 * Java class for caseQntyType complex type.
 * 
 * <p>
...
@XmlType(name = "caseQntyType", propOrder = { "content" })
@Entity
@Table(name = "NumberOfCases")
public class CaseQntyType {
	@Id
	...
	@ManyToOne
	@JoinColumn(name = "FileDimensions_id")
	@XmlTransient
	private DimensnsType dimensnstype;

	public DimensnsType getDimensnstype() {
		return dimensnstype;
	}

	public void setDimensnstype(DimensnsType dimensnstype) {
		this.dimensnstype = dimensnstype;
	}
	 ...
	 * {@link JAXBElement }{@code <}{@link ExtLinkType }{@code >} {@link String }
