...
privileged aspect FileAclController_Roo_Controller {
    ...
    public String FileAclController.create(@Valid FileAcl fileAcl, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
        if (bindingResult.hasErrors()) {
            populateEditForm(uiModel, fileAcl);
    ...
    public String FileAclController.createForm(Model uiModel) {
        populateEditForm(uiModel, new FileAcl());
        return "fileacls/create";
    }
    ...
    public String FileAclController.list(@RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model uiModel) {
    ...
    public String FileAclController.update(@Valid FileAcl fileAcl, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
        if (bindingResult.hasErrors()) {
            populateEditForm(uiModel, fileAcl);
