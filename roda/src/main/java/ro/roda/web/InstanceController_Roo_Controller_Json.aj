...
privileged aspect InstanceController_Roo_Controller_Json {
    ...
    @ResponseBody
    public ResponseEntity<String> InstanceController.showJson(@PathVariable("id") Integer id) {
    ...
    public ResponseEntity<String> InstanceController.deleteFromJson(@PathVariable("id") Integer id) {
        Instance instance = instanceService.findInstance(id);
        HttpHeaders headers = new HttpHeaders();
        headers.add("Content-Type", "application/json");
        if (instance == null) {
