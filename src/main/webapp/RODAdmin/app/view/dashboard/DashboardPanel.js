Ext.define('RODAdmin.view.dashboard.DashboardPanel', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.dashboardpanel',

    requires: ['RODAdmin.view.dashboard.DashboardColumn'],
    ...
    initEvents : function(){
        this.callParent();
        this.dd = Ext.create('RODAdmin.view.dashboard.DashboardDropZone', this, this.dropConfig);
    },
