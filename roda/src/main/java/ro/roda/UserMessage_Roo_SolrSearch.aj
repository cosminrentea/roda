...
privileged aspect UserMessage_Roo_SolrSearch {
    ...
    public static void UserMessage.indexUserMessages(Collection<UserMessage> usermessages) {
        ...
        for (UserMessage userMessage : usermessages) {
            ...
            sid.addField("usermessage_solrsummary_t", new StringBuilder().append(userMessage.getToUserId()).append(" ").append(userMessage.getFromUserId()).append(" ").append(userMessage.getMessage()));
            documents.add(sid);
        }
        try {
