...
privileged aspect Skip_Roo_SolrSearch {
    ...
    public static void Skip.indexSkips(Collection<Skip> skips) {
        ...
        for (Skip skip : skips) {
            ...
            sid.addField("skip.id_i", skip.getId());
            // Add summary field to allow searching documents for objects of this type
            sid.addField("skip_solrsummary_t", new StringBuilder().append(skip.getNextVariableId()).append(" ").append(skip.getVariableId()).append(" ").append(skip.getCondition()).append(" ").append(skip.getId()));
            documents.add(sid);
        }
        try {
