...
public final class FormEditedTextVarPK implements Serializable {
	...
	public boolean equals(final Object obj) {
		if (obj instanceof FormEditedTextVarPK) {
			final FormEditedTextVarPK other = (FormEditedTextVarPK) obj;
			return new EqualsBuilder().append(variableId, other.variableId).append(formId, other.formId).isEquals();
		} else {
			return false;
		}
	}
	...
	@Override
	public int hashCode() {
		return new HashCodeBuilder().append(variableId).append(formId).toHashCode();
	}
}
