...
privileged aspect InstanceVariable_Roo_SolrSearch {
    
    @Autowired
    transient SolrServer InstanceVariable.solrServer;
    
    public static QueryResponse InstanceVariable.search(String queryString) {
        String searchString = "InstanceVariable_solrsummary_t:" + queryString;
        return search(new SolrQuery(searchString.toLowerCase()));
    }
    
    public static QueryResponse InstanceVariable.search(SolrQuery query) {
        try {
    ...
    public static void InstanceVariable.indexInstanceVariable(InstanceVariable instanceVariable) {
    ...
    @Async
    public static void InstanceVariable.indexInstanceVariables(Collection<InstanceVariable> instancevariables) {
    ...
    @Async
    public static void InstanceVariable.deleteIndex(InstanceVariable instanceVariable) {
        SolrServer solrServer = solrServer();
        try {
    ...
    @PostUpdate
    @PostPersist
    private void InstanceVariable.postPersistOrUpdate() {
        indexInstanceVariable(this);
    }
    
    @PreRemove
    private void InstanceVariable.preRemove() {
        deleteIndex(this);
    }
    
    public static SolrServer InstanceVariable.solrServer() {
