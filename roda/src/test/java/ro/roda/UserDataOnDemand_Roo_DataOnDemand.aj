...
privileged aspect UserDataOnDemand_Roo_DataOnDemand {
    ...
    @Autowired
    private AuthDataDataOnDemand UserDataOnDemand.authDataDataOnDemand;
    
    @Autowired
    private UserProfileDataOnDemand UserDataOnDemand.userProfileDataOnDemand;
    ...
    public void UserDataOnDemand.setCredentialProvider(User obj, int index) {
