...
public class UserSettingGroupController {
    ...
    public String create(@Valid UserSettingGroup userSettingGroup, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
    ...
    public String update(@Valid UserSettingGroup userSettingGroup, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
        if (bindingResult.hasErrors()) {
            populateEditForm(uiModel, userSettingGroup);
