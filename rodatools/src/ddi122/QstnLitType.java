...
/**
 * <p>
 * Java class for qstnLitType complex type.
 * 
 * <p>
...
@XmlType(name = "qstnLitType", propOrder = { "content" })
@Entity
@Table(name = "LiteralQuestion")
public class QstnLitType {
	...
	@ManyToOne
	@JoinColumn(name = "qstntype_id")
	@XmlTransient
	private QstnType qstntype;

	public QstnType getQstntype() {
		return qstntype;
	}

	public void setQstntype(QstnType qstntype) {
