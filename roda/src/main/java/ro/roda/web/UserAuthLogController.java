...
public class UserAuthLogController {
	...
	public String create(@Valid UserAuthLog userAuthLog, BindingResult bindingResult, Model uiModel,
	...
	public String update(@Valid UserAuthLog userAuthLog, BindingResult bindingResult, Model uiModel,
			HttpServletRequest httpServletRequest) {
		if (bindingResult.hasErrors()) {
			populateEditForm(uiModel, userAuthLog);
	...
	void addDateTimeFormatPatterns(Model uiModel) {
		uiModel.addAttribute("userAuthLog_authattemptedat_date_format",
