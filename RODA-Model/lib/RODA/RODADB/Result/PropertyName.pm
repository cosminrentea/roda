use utf8;
package RODA::RODADB::Result::PropertyName;
...
RODA::RODADB::Result::PropertyName - Tabel folosit pentru Proprietati (stocheaza numele acestora)
...
=head1 TABLE: C<property_name>

=cut

__PACKAGE__->table("property_name");
...
__PACKAGE__->has_many(
  ...
  { "foreign.property_name_id" => "self.id" },
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:aG6Agloou8lP0/QAk/EA4g
