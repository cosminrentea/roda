...
public class InstancePersonAssocController {
    ...
    public String create(@Valid InstancePersonAssoc instancePersonAssoc, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
    ...
    public String update(@Valid InstancePersonAssoc instancePersonAssoc, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
        if (bindingResult.hasErrors()) {
            populateEditForm(uiModel, instancePersonAssoc);
