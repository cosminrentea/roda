...
public class FormEditedTextVarController {
    ...
    public String create(@Valid FormEditedTextVar formEditedTextVar, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
    ...
    public String list(@RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model uiModel) {
        if (page != null || size != null) {
            ...
            uiModel.addAttribute("formeditedtextvars", formEditedTextVarService.findFormEditedTextVarEntries(firstResult, sizeNo));
    ...
    public String update(@Valid FormEditedTextVar formEditedTextVar, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
        if (bindingResult.hasErrors()) {
            populateEditForm(uiModel, formEditedTextVar);
    ...
    public String delete(@PathVariable("id") FormEditedTextVarPK id, @RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model uiModel) {
