...
public class CmsPageContentController {
	...
	public String create(@Valid CmsPageContent cmsPageContent, BindingResult bindingResult, Model uiModel,
		...
		return "redirect:/cmspagecontents/"
				+ encodeUrlPathSegment(cmsPageContent.getId().toString(), httpServletRequest);
	}
	...
	public String list(@RequestParam(value = "page", required = false) Integer page,
		...
		if (page != null || size != null) {
			...
			uiModel.addAttribute("cmspagecontents",
					cmsPageContentService.findCmsPageContentEntries(firstResult, sizeNo));
	...
	public String update(@Valid CmsPageContent cmsPageContent, BindingResult bindingResult, Model uiModel,
			HttpServletRequest httpServletRequest) {
		if (bindingResult.hasErrors()) {
			populateEditForm(uiModel, cmsPageContent);
	...
	void populateEditForm(Model uiModel, CmsPageContent cmsPageContent) {
