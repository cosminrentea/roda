...
public class CmsSnippetGroupController {
	...
	public String create(@Valid CmsSnippetGroup cmsSnippetGroup, BindingResult bindingResult, Model uiModel,
		...
		return "redirect:/cmssnippetgroups/"
				+ encodeUrlPathSegment(cmsSnippetGroup.getId().toString(), httpServletRequest);
	}
	...
	public String list(@RequestParam(value = "page", required = false) Integer page,
		...
		if (page != null || size != null) {
			...
			uiModel.addAttribute("cmssnippetgroups",
					cmsSnippetGroupService.findCmsSnippetGroupEntries(firstResult, sizeNo));
	...
	public String update(@Valid CmsSnippetGroup cmsSnippetGroup, BindingResult bindingResult, Model uiModel,
			HttpServletRequest httpServletRequest) {
		if (bindingResult.hasErrors()) {
			populateEditForm(uiModel, cmsSnippetGroup);
