...
public class OrgEmailController {
    ...
    public String create(@Valid OrgEmail orgEmail, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
    ...
    public String update(@Valid OrgEmail orgEmail, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
        if (bindingResult.hasErrors()) {
            populateEditForm(uiModel, orgEmail);
    ...
    public String delete(@PathVariable("id") OrgEmailPK id, @RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model uiModel) {
        OrgEmail orgEmail = orgEmailService.findOrgEmail(id);
        orgEmailService.deleteOrgEmail(orgEmail);
        uiModel.asMap().clear();
