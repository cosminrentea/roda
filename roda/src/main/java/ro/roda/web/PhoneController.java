...
public class PhoneController {
	...
	public String create(@Valid Phone phone, BindingResult bindingResult, Model uiModel,
	...
	public String update(@Valid Phone phone, BindingResult bindingResult, Model uiModel,
			HttpServletRequest httpServletRequest) {
		if (bindingResult.hasErrors()) {
			populateEditForm(uiModel, phone);
