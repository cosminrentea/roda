...
package RODA::RODADB::ResultSet::StudyOrgAssoc;
use strict;
use warnings;
use Data::Dumper;
...
RODA::RODADB::ResultSet::StudyOrgAssoc - metode specifice pentru manipularea tipurilor de asociere intre organizatii si studii
...
Metode suplimentare care se aplica asupra seturilor de rezultate de tip asociere intre studiu si organizatie.
...
=item C<assoc_id>
- cheia primara a tipului de asociere in tabelul study_org_assoc

=item C<assoc_name>
- denumirea tipului de asociere intre studiu si organizatie

=item C<assoc_description>
- descrierea tipului de asociere intre studiu si organizatie
...
sub checkassoctype {
    ...
    # Verificarea unicitatii unui tip de asociere intre studiu si organizatie 
