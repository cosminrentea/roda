...
public class StudyPersonAsocController {
    ...
    public String create(@Valid StudyPersonAsoc studyPersonAsoc, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
    ...
    public String update(@Valid StudyPersonAsoc studyPersonAsoc, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
        if (bindingResult.hasErrors()) {
            populateEditForm(uiModel, studyPersonAsoc);
