...
public class StudyDocumentsController {
    ...
    public String create(@Valid StudyDocuments studyDocuments, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
    ...
    public String update(@Valid StudyDocuments studyDocuments, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
        if (bindingResult.hasErrors()) {
            populateEditForm(uiModel, studyDocuments);
    ...
    public String delete(@PathVariable("id") StudyDocumentsPK id, @RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model uiModel) {
