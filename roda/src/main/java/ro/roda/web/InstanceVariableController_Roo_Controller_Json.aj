...
privileged aspect InstanceVariableController_Roo_Controller_Json {
    
    @RequestMapping(value = "/{id}", headers = "Accept=application/json")
    @ResponseBody
    public ResponseEntity<String> InstanceVariableController.showJson(@PathVariable("id") InstanceVariablePK id) {
    ...
    @ResponseBody
    public ResponseEntity<String> InstanceVariableController.listJson() {
        HttpHeaders headers = new HttpHeaders();
        headers.add("Content-Type", "application/json; charset=utf-8");
    ...
    public ResponseEntity<String> InstanceVariableController.createFromJson(@RequestBody String json) {
    ...
    public ResponseEntity<String> InstanceVariableController.createFromJsonArray(@RequestBody String json) {
    ...
    public ResponseEntity<String> InstanceVariableController.updateFromJson(@RequestBody String json) {
        HttpHeaders headers = new HttpHeaders();
        headers.add("Content-Type", "application/json");
        InstanceVariable instanceVariable = InstanceVariable.fromJsonToInstanceVariable(json);
    ...
    public ResponseEntity<String> InstanceVariableController.updateFromJsonArray(@RequestBody String json) {
        HttpHeaders headers = new HttpHeaders();
        headers.add("Content-Type", "application/json");
        for (InstanceVariable instanceVariable: InstanceVariable.fromJsonArrayToInstanceVariables(json)) {
            if (instanceVariableService.updateInstanceVariable(instanceVariable) == null) {
    ...
    public ResponseEntity<String> InstanceVariableController.deleteFromJson(@PathVariable("id") InstanceVariablePK id) {
        InstanceVariable instanceVariable = instanceVariableService.findInstanceVariable(id);
        HttpHeaders headers = new HttpHeaders();
        headers.add("Content-Type", "application/json");
        if (instanceVariable == null) {
