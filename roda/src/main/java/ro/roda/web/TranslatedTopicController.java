...
public class TranslatedTopicController {
    ...
    public String create(@Valid TranslatedTopic translatedTopic, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
    ...
    public String update(@Valid TranslatedTopic translatedTopic, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
        if (bindingResult.hasErrors()) {
            populateEditForm(uiModel, translatedTopic);
    ...
    public String delete(@PathVariable("id") TranslatedTopicPK id, @RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model uiModel) {
