...
public class RegionController {
	...
	public String create(@Valid Region region, BindingResult bindingResult, Model uiModel,
	...
	public String update(@Valid Region region, BindingResult bindingResult, Model uiModel,
			HttpServletRequest httpServletRequest) {
		if (bindingResult.hasErrors()) {
			populateEditForm(uiModel, region);
