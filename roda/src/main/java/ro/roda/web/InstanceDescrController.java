...
public class InstanceDescrController {
	...
	public String create(@Valid InstanceDescr instanceDescr, BindingResult bindingResult, Model uiModel,
		...
		return "redirect:/instancedescrs/"
				+ encodeUrlPathSegment(conversionService.convert(instanceDescr.getId(), String.class),
						httpServletRequest);
	}
	...
	public String update(@Valid InstanceDescr instanceDescr, BindingResult bindingResult, Model uiModel,
			HttpServletRequest httpServletRequest) {
		if (bindingResult.hasErrors()) {
			populateEditForm(uiModel, instanceDescr);
	...
	public String delete(@PathVariable("id") InstanceDescrPK id,
