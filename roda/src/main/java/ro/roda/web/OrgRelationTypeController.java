...
public class OrgRelationTypeController {
    ...
    public String create(@Valid OrgRelationType orgRelationType, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
    ...
    public String update(@Valid OrgRelationType orgRelationType, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
        if (bindingResult.hasErrors()) {
            populateEditForm(uiModel, orgRelationType);
