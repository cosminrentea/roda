...
public class CmsPageContentController {
    ...
    public String create(@Valid CmsPageContent cmsPageContent, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
    ...
    public String update(@Valid CmsPageContent cmsPageContent, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
        if (bindingResult.hasErrors()) {
            populateEditForm(uiModel, cmsPageContent);
