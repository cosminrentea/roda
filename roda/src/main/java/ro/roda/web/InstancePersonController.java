...
public class InstancePersonController {
	...
	public String create(@Valid InstancePerson instancePerson, BindingResult bindingResult, Model uiModel,
		...
		return "redirect:/instancepeople/"
				+ encodeUrlPathSegment(conversionService.convert(instancePerson.getId(), String.class),
						httpServletRequest);
	}
	...
	public String update(@Valid InstancePerson instancePerson, BindingResult bindingResult, Model uiModel,
			HttpServletRequest httpServletRequest) {
		if (bindingResult.hasErrors()) {
			populateEditForm(uiModel, instancePerson);
	...
	public String delete(@PathVariable("id") InstancePersonPK id,
