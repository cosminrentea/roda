...
privileged aspect UserSettingValueController_Roo_Controller_Json {
    
    @RequestMapping(value = "/{id}", headers = "Accept=application/json")
    @ResponseBody
    public ResponseEntity<String> UserSettingValueController.showJson(@PathVariable("id") UserSettingValuePK id) {
    ...
    @ResponseBody
    public ResponseEntity<String> UserSettingValueController.listJson() {
        HttpHeaders headers = new HttpHeaders();
        headers.add("Content-Type", "application/json; charset=utf-8");
    ...
    public ResponseEntity<String> UserSettingValueController.createFromJson(@RequestBody String json) {
    ...
    public ResponseEntity<String> UserSettingValueController.createFromJsonArray(@RequestBody String json) {
    ...
    public ResponseEntity<String> UserSettingValueController.updateFromJson(@RequestBody String json) {
        HttpHeaders headers = new HttpHeaders();
        headers.add("Content-Type", "application/json");
        UserSettingValue userSettingValue = UserSettingValue.fromJsonToUserSettingValue(json);
    ...
    public ResponseEntity<String> UserSettingValueController.updateFromJsonArray(@RequestBody String json) {
        HttpHeaders headers = new HttpHeaders();
        headers.add("Content-Type", "application/json");
        for (UserSettingValue userSettingValue: UserSettingValue.fromJsonArrayToUserSettingValues(json)) {
            if (userSettingValueService.updateUserSettingValue(userSettingValue) == null) {
    ...
    public ResponseEntity<String> UserSettingValueController.deleteFromJson(@PathVariable("id") UserSettingValuePK id) {
        UserSettingValue userSettingValue = userSettingValueService.findUserSettingValue(id);
        HttpHeaders headers = new HttpHeaders();
        headers.add("Content-Type", "application/json");
        if (userSettingValue == null) {
