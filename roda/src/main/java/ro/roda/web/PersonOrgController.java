...
public class PersonOrgController {
	...
	public String create(@Valid PersonOrg personOrg, BindingResult bindingResult, Model uiModel,
		...
		return "redirect:/personorgs/"
				+ encodeUrlPathSegment(conversionService.convert(personOrg.getId(), String.class), httpServletRequest);
	}
	...
	public String update(@Valid PersonOrg personOrg, BindingResult bindingResult, Model uiModel,
			HttpServletRequest httpServletRequest) {
		if (bindingResult.hasErrors()) {
			populateEditForm(uiModel, personOrg);
	...
	public String delete(@PathVariable("id") PersonOrgPK id,
	...
	void addDateTimeFormatPatterns(Model uiModel) {
		uiModel.addAttribute("personOrg_datestart_date_format",
				DateTimeFormat.patternForStyle("M-", LocaleContextHolder.getLocale()));
		uiModel.addAttribute("personOrg_dateend_date_format",
				DateTimeFormat.patternForStyle("M-", LocaleContextHolder.getLocale()));
	}
