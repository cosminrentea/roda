...
public class FormEditedNumberVarController {
	...
	public String create(@Valid FormEditedNumberVar formEditedNumberVar, BindingResult bindingResult, Model uiModel,
		...
		return "redirect:/formeditednumbervars/"
				+ encodeUrlPathSegment(conversionService.convert(formEditedNumberVar.getId(), String.class),
						httpServletRequest);
	}
	...
	public String list(@RequestParam(value = "page", required = false) Integer page,
		...
		if (page != null || size != null) {
			...
			uiModel.addAttribute("formeditednumbervars",
					formEditedNumberVarService.findFormEditedNumberVarEntries(firstResult, sizeNo));
	...
	public String update(@Valid FormEditedNumberVar formEditedNumberVar, BindingResult bindingResult, Model uiModel,
			HttpServletRequest httpServletRequest) {
		if (bindingResult.hasErrors()) {
			populateEditForm(uiModel, formEditedNumberVar);
	...
	public String delete(@PathVariable("id") FormEditedNumberVarPK id,
