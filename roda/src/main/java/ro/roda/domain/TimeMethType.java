...
public class TimeMethType {
    ...
    public static void indexTimeMethTypes(Collection<TimeMethType> timemethtypes) {
        ...
        for (TimeMethType timeMethType : timemethtypes) {
            ...
            sid.addField("timemethtype_solrsummary_t", new StringBuilder().append(timeMethType.getStudy()).append(" ").append(timeMethType.getName()).append(" ").append(timeMethType.getDescription()).append(" ").append(timeMethType.getId()));
            documents.add(sid);
        }
        try {
