...
public class CmsLayoutController {
	...
	public String create(@Valid CmsLayout cmsLayout, BindingResult bindingResult, Model uiModel,
	...
	public String update(@Valid CmsLayout cmsLayout, BindingResult bindingResult, Model uiModel,
			HttpServletRequest httpServletRequest) {
		if (bindingResult.hasErrors()) {
			populateEditForm(uiModel, cmsLayout);
