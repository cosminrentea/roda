...
public class DataSourceType {
	...
	/**
	 * Verifica existenta unui obiect de tip <code>DataSourceType</code> (tip de
	 * sursa de date) in baza de date; in caz afirmativ il returneaza, altfel,
