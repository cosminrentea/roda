...
privileged aspect Study_Roo_SolrSearch {
    ...
    public static void Study.indexStudys(Collection<Study> studys) {
        ...
        for (Study study : studys) {
            ...
            sid.addField("study.datestart_dt", study.getDatestart().getTime());
            sid.addField("study.dateend_dt", study.getDateend().getTime());
            ...
            sid.addField("study_solrsummary_t", new StringBuilder().append(study.getAddedBy()).append(" ").append(study.getDatestart().getTime()).append(" ").append(study.getDateend().getTime()).append(" ").append(study.getInsertionStatus()).append(" ").append(study.getAdded().getTime()).append(" ").append(study.getId()));
            documents.add(sid);
        }
        try {
