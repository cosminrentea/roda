use utf8;
package RODA::RODADB::Result::VariableGroup;
...
=head1 TABLE: C<variable_group>

=cut

__PACKAGE__->table("variable_group");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:w1BYVe5dPYSmFI2Vcq02zA
