...
privileged aspect UserProfileDataOnDemand_Roo_DataOnDemand {
    ...
    public void UserProfileDataOnDemand.setEmail(UserProfile obj, int index) {
    ...
    public void UserProfileDataOnDemand.setFName(UserProfile obj, int index) {
    ...
    public void UserProfileDataOnDemand.setLName(UserProfile obj, int index) {
