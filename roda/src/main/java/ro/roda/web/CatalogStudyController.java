...
public class CatalogStudyController {
    ...
    public String create(@Valid CatalogStudy catalogStudy, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
    ...
    public String update(@Valid CatalogStudy catalogStudy, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
        if (bindingResult.hasErrors()) {
            populateEditForm(uiModel, catalogStudy);
    ...
    public String delete(@PathVariable("id") CatalogStudyPK id, @RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model uiModel) {
        CatalogStudy catalogStudy = catalogStudyService.findCatalogStudy(id);
        catalogStudyService.deleteCatalogStudy(catalogStudy);
        uiModel.asMap().clear();
