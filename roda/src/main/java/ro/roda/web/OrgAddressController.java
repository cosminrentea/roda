...
public class OrgAddressController {
	...
	public String create(@Valid OrgAddress orgAddress, BindingResult bindingResult, Model uiModel,
		...
		return "redirect:/orgaddresses/"
				+ encodeUrlPathSegment(conversionService.convert(orgAddress.getId(), String.class), httpServletRequest);
	}
	...
	public String update(@Valid OrgAddress orgAddress, BindingResult bindingResult, Model uiModel,
			HttpServletRequest httpServletRequest) {
		if (bindingResult.hasErrors()) {
			populateEditForm(uiModel, orgAddress);
	...
	public String delete(@PathVariable("id") OrgAddressPK id,
	...
	void addDateTimeFormatPatterns(Model uiModel) {
		uiModel.addAttribute("orgAddress_datestart_date_format",
				DateTimeFormat.patternForStyle("M-", LocaleContextHolder.getLocale()));
		uiModel.addAttribute("orgAddress_dateend_date_format",
				DateTimeFormat.patternForStyle("M-", LocaleContextHolder.getLocale()));
	}
