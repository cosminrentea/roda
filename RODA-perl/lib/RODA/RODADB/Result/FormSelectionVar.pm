...
Tabel ce salveaza raspunsurile la variabilele pentru care exista optiuni de raspuns 
...
Identificatorul unui formular completat in cadrul instantei identificate prin atributul instance_id
...
Identificatorul unei variabile din cadrul instantei identificate prin atributul instance_id
...
__PACKAGE__->set_primary_key("instance_id", "form_id", "variable_id", "item_id");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:IAQUWEeVOve+ITFse57e6w
