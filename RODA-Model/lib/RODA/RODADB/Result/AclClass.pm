...
Tabel folosit de Spring Security pentru ACL. Uniquely identify any domain object class in the system. The only columns are the ID and the Java class name. Thus, there is a single row for each unique Class we wish to store ACL permissions for.
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:QEUwm9Fj9NIU07iRhXREeg
