...
public class ValueController {
	...
	public String create(@Valid Value value, BindingResult bindingResult, Model uiModel,
	...
	public String update(@Valid Value value, BindingResult bindingResult, Model uiModel,
			HttpServletRequest httpServletRequest) {
		if (bindingResult.hasErrors()) {
			populateEditForm(uiModel, value);
