...
privileged aspect OrgRelationTypeDataOnDemand_Roo_DataOnDemand {
    ...
    declare @type: OrgRelationTypeDataOnDemand: @Component;
    ...
    public void OrgRelationTypeDataOnDemand.setName(OrgRelationType obj, int index) {
    ...
    public OrgRelationType OrgRelationTypeDataOnDemand.getSpecificOrgRelationType(int index) {
        init();
        if (index < 0) {
            index = 0;
        }
    ...
    public void OrgRelationTypeDataOnDemand.init() {
        ...
        data = new ArrayList<OrgRelationType>();
        for (int i = 0; i < 10; i++) {
