...
privileged aspect CityController_Roo_Controller_Json {
    ...
    @ResponseBody
    public ResponseEntity<String> CityController.showJson(@PathVariable("id") Integer id) {
    ...
    public ResponseEntity<String> CityController.deleteFromJson(@PathVariable("id") Integer id) {
        City city = cityService.findCity(id);
        HttpHeaders headers = new HttpHeaders();
        headers.add("Content-Type", "application/json");
        if (city == null) {
