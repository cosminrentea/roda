Ext.define('RODAdmin.view.dashboard.DashboardDropZone', {
    extend: 'Ext.dd.DropTarget',

    constructor: function(dashboard, cfg) {
        this.dashboard = dashboard;
        Ext.dd.ScrollManager.register(dashboard.body);
        RODAdmin.view.dashboard.DashboardDropZone.superclass.constructor.call(this, dashboard.body, cfg);
    ...
    unreg: function() {
        ...
        RODAdmin.view.dashboard.DashboardDropZone.superclass.unreg.call(this);
    }
});
