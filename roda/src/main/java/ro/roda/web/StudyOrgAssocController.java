...
public class StudyOrgAssocController {
	...
	public String create(@Valid StudyOrgAssoc studyOrgAssoc, BindingResult bindingResult, Model uiModel,
	...
	public String update(@Valid StudyOrgAssoc studyOrgAssoc, BindingResult bindingResult, Model uiModel,
			HttpServletRequest httpServletRequest) {
		if (bindingResult.hasErrors()) {
			populateEditForm(uiModel, studyOrgAssoc);
