...
public class UserMessageController {
	...
	public String create(@Valid UserMessage userMessage, BindingResult bindingResult, Model uiModel,
	...
	public String update(@Valid UserMessage userMessage, BindingResult bindingResult, Model uiModel,
			HttpServletRequest httpServletRequest) {
		if (bindingResult.hasErrors()) {
			populateEditForm(uiModel, userMessage);
