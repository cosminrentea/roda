...
public class StudyPersonAssocController {
    ...
    public String create(@Valid StudyPersonAssoc studyPersonAssoc, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
    ...
    public String update(@Valid StudyPersonAssoc studyPersonAssoc, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
        if (bindingResult.hasErrors()) {
            populateEditForm(uiModel, studyPersonAssoc);
