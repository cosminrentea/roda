...
privileged aspect FormIntegrationTest_Roo_IntegrationTest {
    ...
    @Autowired
    FormService FormIntegrationTest.formService;
    
    @Test
    public void FormIntegrationTest.testCountAllForms() {
        Assert.assertNotNull("Data on demand for 'Form' failed to initialize correctly", dod.getRandomForm());
        long count = formService.countAllForms();
    ...
    public void FormIntegrationTest.testFindFormEntries() {
        ...
        List<Form> result = formService.findFormEntries(firstResult, maxResults);
    ...
    @Test
    public void FormIntegrationTest.testSaveForm() {
        Assert.assertNotNull("Data on demand for 'Form' failed to initialize correctly", dod.getRandomForm());
    ...
    @Test
    public void FormIntegrationTest.testDeleteForm() {
        Form obj = dod.getRandomForm();
        Assert.assertNotNull("Data on demand for 'Form' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'Form' failed to provide an identifier", id);
        obj = formService.findForm(id);
        formService.deleteForm(obj);
        obj.flush();
        Assert.assertNull("Failed to remove 'Form' with identifier '" + id + "'", formService.findForm(id));
    }
