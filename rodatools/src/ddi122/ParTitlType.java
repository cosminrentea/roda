...
/**
 * <p>
 * Java class for parTitlType complex type.
 * 
 * <p>
...
@XmlType(name = "parTitlType", propOrder = { "content" })
@Entity
@Table(name = "ParallelTitle")
public class ParTitlType {
	@Id
	...
	@ManyToOne
	@JoinColumn(name = "TitleStatement_id")
	@XmlTransient
	private TitlStmtType titlstmttype;

	public TitlStmtType getTitlstmttype() {
		return titlstmttype;
	}

	public void setTitlstmttype(TitlStmtType titlstmttype) {
		this.titlstmttype = titlstmttype;
	}
