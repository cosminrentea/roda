...
public class TargetGroupController {
	...
	public String create(@Valid TargetGroup targetGroup, BindingResult bindingResult, Model uiModel,
	...
	public String update(@Valid TargetGroup targetGroup, BindingResult bindingResult, Model uiModel,
			HttpServletRequest httpServletRequest) {
		if (bindingResult.hasErrors()) {
			populateEditForm(uiModel, targetGroup);
