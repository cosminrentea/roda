...
Tabel ce contine listele pentru controlul accesului la nivel de studiu
...
__PACKAGE__->set_primary_key("study_id", "aro_id", "aro_type");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:85zSCxMQIhQE9ZGzCMrKBg
