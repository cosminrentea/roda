...
Tabel ce contine asocierile dintre organizatii si adrese (implementeaza relatia many-to-many intre tabelele org si adresa)
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:OJknbnZJqmx365i3+nQLjg
