...
public class OrgRelationsController {
	...
	public String create(@Valid OrgRelations orgRelations, BindingResult bindingResult, Model uiModel,
		...
		return "redirect:/orgrelationses/"
				+ encodeUrlPathSegment(conversionService.convert(orgRelations.getId(), String.class),
						httpServletRequest);
	}
	...
	public String update(@Valid OrgRelations orgRelations, BindingResult bindingResult, Model uiModel,
			HttpServletRequest httpServletRequest) {
		if (bindingResult.hasErrors()) {
			populateEditForm(uiModel, orgRelations);
	...
	public String delete(@PathVariable("id") OrgRelationsPK id,
	...
	void addDateTimeFormatPatterns(Model uiModel) {
		uiModel.addAttribute("orgRelations_datestart_date_format",
				DateTimeFormat.patternForStyle("M-", LocaleContextHolder.getLocale()));
		uiModel.addAttribute("orgRelations_dateend_date_format",
				DateTimeFormat.patternForStyle("M-", LocaleContextHolder.getLocale()));
	}
