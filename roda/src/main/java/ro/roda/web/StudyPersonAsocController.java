...
public class StudyPersonAsocController {
	...
	public String create(@Valid StudyPersonAsoc studyPersonAsoc, BindingResult bindingResult, Model uiModel,
		...
		return "redirect:/studypersonasocs/"
				+ encodeUrlPathSegment(studyPersonAsoc.getId().toString(), httpServletRequest);
	}
	...
	public String list(@RequestParam(value = "page", required = false) Integer page,
		...
		if (page != null || size != null) {
			...
			uiModel.addAttribute("studypersonasocs",
					studyPersonAsocService.findStudyPersonAsocEntries(firstResult, sizeNo));
	...
	public String update(@Valid StudyPersonAsoc studyPersonAsoc, BindingResult bindingResult, Model uiModel,
			HttpServletRequest httpServletRequest) {
		if (bindingResult.hasErrors()) {
			populateEditForm(uiModel, studyPersonAsoc);
	...
	void populateEditForm(Model uiModel, StudyPersonAsoc studyPersonAsoc) {
	...
	public ResponseEntity<String> showJson(@PathVariable("id") Integer id) {
		...
		if (studyPersonAsoc == null) {
			return new ResponseEntity<String>(headers, HttpStatus.NOT_FOUND);
		}
		return new ResponseEntity<String>(studyPersonAsoc.toJson(), headers, HttpStatus.OK);
	}
	...
	public ResponseEntity<String> listJson() {
		...
		return new ResponseEntity<String>(StudyPersonAsoc.toJsonArray(result), headers, HttpStatus.OK);
	}

	@RequestMapping(method = RequestMethod.POST, headers = "Accept=application/json")
	public ResponseEntity<String> createFromJson(@RequestBody String json) {
		StudyPersonAsoc studyPersonAsoc = StudyPersonAsoc.fromJsonToStudyPersonAsoc(json);
		studyPersonAsocService.saveStudyPersonAsoc(studyPersonAsoc);
		HttpHeaders headers = new HttpHeaders();
	...
	public ResponseEntity<String> createFromJsonArray(@RequestBody String json) {
		for (StudyPersonAsoc studyPersonAsoc : StudyPersonAsoc.fromJsonArrayToStudyPersonAsocs(json)) {
			studyPersonAsocService.saveStudyPersonAsoc(studyPersonAsoc);
		}
		HttpHeaders headers = new HttpHeaders();
		headers.add("Content-Type", "application/json");
	...
	public ResponseEntity<String> updateFromJson(@RequestBody String json) {
		...
		headers.add("Content-Type", "application/json");
		StudyPersonAsoc studyPersonAsoc = StudyPersonAsoc.fromJsonToStudyPersonAsoc(json);
		if (studyPersonAsocService.updateStudyPersonAsoc(studyPersonAsoc) == null) {
			return new ResponseEntity<String>(headers, HttpStatus.NOT_FOUND);
		}
