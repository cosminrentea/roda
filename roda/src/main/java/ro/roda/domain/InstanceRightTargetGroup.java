...
public class InstanceRightTargetGroup {
	...
	public static long countInstanceRightTargetGroups() {
        return entityManager().createQuery("SELECT COUNT(o) FROM InstanceRightTargetGroup o", Long.class).getSingleResult();
    }

	public static List<InstanceRightTargetGroup> findAllInstanceRightTargetGroups() {
        return entityManager().createQuery("SELECT o FROM InstanceRightTargetGroup o", InstanceRightTargetGroup.class).getResultList();
    }
	...
	public static List<InstanceRightTargetGroup> findInstanceRightTargetGroupEntries(int firstResult, int maxResults) {
        return entityManager().createQuery("SELECT o FROM InstanceRightTargetGroup o", InstanceRightTargetGroup.class).setFirstResult(firstResult).setMaxResults(maxResults).getResultList();
    }
