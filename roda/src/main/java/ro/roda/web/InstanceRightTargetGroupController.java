...
public class InstanceRightTargetGroupController {
    ...
    public String create(@Valid InstanceRightTargetGroup instanceRightTargetGroup, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
        ...
        uiModel.asMap().clear();
        instanceRightTargetGroupService.saveInstanceRightTargetGroup(instanceRightTargetGroup);
        return "redirect:/instancerighttargetgroups/" + encodeUrlPathSegment(conversionService.convert(instanceRightTargetGroup.getId(), String.class), httpServletRequest);
    }
    ...
    public String show(@PathVariable("id") InstanceRightTargetGroupPK id, Model uiModel) {
        uiModel.addAttribute("instancerighttargetgroup", instanceRightTargetGroupService.findInstanceRightTargetGroup(id));
    ...
    public String list(@RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model uiModel) {
        if (page != null || size != null) {
            ...
            uiModel.addAttribute("instancerighttargetgroups", instanceRightTargetGroupService.findInstanceRightTargetGroupEntries(firstResult, sizeNo));
    ...
    public String update(@Valid InstanceRightTargetGroup instanceRightTargetGroup, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
        if (bindingResult.hasErrors()) {
            populateEditForm(uiModel, instanceRightTargetGroup);
    ...
    public String delete(@PathVariable("id") InstanceRightTargetGroupPK id, @RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model uiModel) {
        InstanceRightTargetGroup instanceRightTargetGroup = instanceRightTargetGroupService.findInstanceRightTargetGroup(id);
        instanceRightTargetGroupService.deleteInstanceRightTargetGroup(instanceRightTargetGroup);
        uiModel.asMap().clear();
