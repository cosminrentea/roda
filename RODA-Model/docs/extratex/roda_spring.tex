...
\subsubsection{Modelul domeniului}
...
procesul de generare este in acest moment inversat - folosindu-se o abordare \emph{reverse-engineering}, respectiv: model -> baza de date. %TODO ??? sageata
...
\subsubsection{View-uri pe server}
...
\subsubsection{Procese de Build}
