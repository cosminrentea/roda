...
privileged aspect OrgEmailController_Roo_Controller {
    ...
    public String OrgEmailController.create(@Valid OrgEmail orgEmail, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
    ...
    public String OrgEmailController.createForm(Model uiModel) {
    ...
    public String OrgEmailController.list(@RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model uiModel) {
    ...
    public String OrgEmailController.update(@Valid OrgEmail orgEmail, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
        if (bindingResult.hasErrors()) {
            populateEditForm(uiModel, orgEmail);
