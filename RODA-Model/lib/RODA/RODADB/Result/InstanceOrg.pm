...
Tabel ce contine asocierile dintre instante si organizatii (implementeaza relatia many-to-many intre tabelele instance si org)
...
__PACKAGE__->set_primary_key("org_id", "instance_id", "assoc_type_id");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:4demZiB83aIEN8f77g7ZZA
