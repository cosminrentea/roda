...
public class InstanceOrgAssocController {
	...
	public String create(@Valid InstanceOrgAssoc instanceOrgAssoc, BindingResult bindingResult, Model uiModel,
		...
		return "redirect:/instanceorgassocs/"
				+ encodeUrlPathSegment(instanceOrgAssoc.getId().toString(), httpServletRequest);
	}
	...
	public String list(@RequestParam(value = "page", required = false) Integer page,
		...
		if (page != null || size != null) {
			...
			uiModel.addAttribute("instanceorgassocs",
					instanceOrgAssocService.findInstanceOrgAssocEntries(firstResult, sizeNo));
	...
	public String update(@Valid InstanceOrgAssoc instanceOrgAssoc, BindingResult bindingResult, Model uiModel,
			HttpServletRequest httpServletRequest) {
		if (bindingResult.hasErrors()) {
			populateEditForm(uiModel, instanceOrgAssoc);
