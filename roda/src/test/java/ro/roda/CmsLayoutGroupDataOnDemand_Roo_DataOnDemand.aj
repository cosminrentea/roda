...
privileged aspect CmsLayoutGroupDataOnDemand_Roo_DataOnDemand {
    ...
    declare @type: CmsLayoutGroupDataOnDemand: @Component;
    ...
    public void CmsLayoutGroupDataOnDemand.setDescription(CmsLayoutGroup obj, int index) {
        String description = "description_" + index;
        obj.setDescription(description);
    }
    
    public void CmsLayoutGroupDataOnDemand.setName(CmsLayoutGroup obj, int index) {
    ...
    public CmsLayoutGroup CmsLayoutGroupDataOnDemand.getSpecificCmsLayoutGroup(int index) {
        init();
        if (index < 0) {
            index = 0;
        }
    ...
    public void CmsLayoutGroupDataOnDemand.init() {
        ...
        data = new ArrayList<CmsLayoutGroup>();
        for (int i = 0; i < 10; i++) {
