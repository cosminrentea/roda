...
public class CollectionModelTypeController {
    ...
    public String create(@Valid CollectionModelType collectionModelType, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
    ...
    public String list(@RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model uiModel) {
        if (page != null || size != null) {
            ...
            uiModel.addAttribute("collectionmodeltypes", collectionModelTypeService.findCollectionModelTypeEntries(firstResult, sizeNo));
    ...
    public String update(@Valid CollectionModelType collectionModelType, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
        if (bindingResult.hasErrors()) {
            populateEditForm(uiModel, collectionModelType);
