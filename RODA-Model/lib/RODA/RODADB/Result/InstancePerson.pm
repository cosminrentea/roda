...
Tabel care stocheaza asocierile intre instante si persoane (implementeaza relatia many-to-many intre tabelele person si instance)
...
=item * L</assoc_type_id>

=back

=cut

__PACKAGE__->set_primary_key("person_id", "instance_id", "assoc_type_id");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:eOLihbtRzmMW97YzOf/ZJw
