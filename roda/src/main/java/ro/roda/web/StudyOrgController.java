...
public class StudyOrgController {
    ...
    public String create(@Valid StudyOrg studyOrg, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
        ...
        uiModel.asMap().clear();
        studyOrgService.saveStudyOrg(studyOrg);
        return "redirect:/studyorgs/" + encodeUrlPathSegment(conversionService.convert(studyOrg.getId(), String.class), httpServletRequest);
    }
    ...
    public String update(@Valid StudyOrg studyOrg, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
        if (bindingResult.hasErrors()) {
            populateEditForm(uiModel, studyOrg);
    ...
    public String delete(@PathVariable("id") StudyOrgPK id, @RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model uiModel) {
        StudyOrg studyOrg = studyOrgService.findStudyOrg(id);
        studyOrgService.deleteStudyOrg(studyOrg);
        uiModel.asMap().clear();
