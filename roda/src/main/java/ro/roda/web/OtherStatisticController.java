...
public class OtherStatisticController {
	...
	public String create(@Valid OtherStatistic otherStatistic, BindingResult bindingResult, Model uiModel,
		...
		return "redirect:/otherstatistics/"
				+ encodeUrlPathSegment(otherStatistic.getId().toString(), httpServletRequest);
	}
	...
	public String list(@RequestParam(value = "page", required = false) Integer page,
		...
		if (page != null || size != null) {
			...
			uiModel.addAttribute("otherstatistics",
					otherStatisticService.findOtherStatisticEntries(firstResult, sizeNo));
	...
	public String update(@Valid OtherStatistic otherStatistic, BindingResult bindingResult, Model uiModel,
			HttpServletRequest httpServletRequest) {
		if (bindingResult.hasErrors()) {
			populateEditForm(uiModel, otherStatistic);
	...
	void populateEditForm(Model uiModel, OtherStatistic otherStatistic) {
