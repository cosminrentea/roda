...
privileged aspect PersonOrg_Roo_SolrSearch {
    ...
    public static void PersonOrg.indexPersonOrgs(Collection<PersonOrg> personorgs) {
        ...
        for (PersonOrg personOrg : personorgs) {
            ...
            sid.addField("personorg_solrsummary_t", new StringBuilder().append(personOrg.getOrgId()).append(" ").append(personOrg.getPersonId()).append(" ").append(personOrg.getRoleId()).append(" ").append(personOrg.getDateend()));
            documents.add(sid);
        }
        try {
