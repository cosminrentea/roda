...
public class InstanceVariableController {
    ...
    public String create(@Valid InstanceVariable instanceVariable, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
    ...
    public String update(@Valid InstanceVariable instanceVariable, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
        if (bindingResult.hasErrors()) {
            populateEditForm(uiModel, instanceVariable);
    ...
    public String delete(@PathVariable("id") InstanceVariablePK id, @RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model uiModel) {
