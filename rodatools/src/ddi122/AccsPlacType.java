...
/**
 * <p>
 * Java class for accsPlacType complex type.
 * 
 * <p>
...
@XmlType(name = "accsPlacType", propOrder = { "content" })
@Entity
...
public class AccsPlacType {
	...
	@ManyToOne
	@JoinColumn(name = "DataSetAvailability_id")
	@XmlTransient
	private SetAvailType setavailtype;

	public SetAvailType getSetavailtype() {
		return setavailtype;
	}

	public void setSetavailtype(SetAvailType setavailtype) {
		this.setavailtype = setavailtype;
	}
