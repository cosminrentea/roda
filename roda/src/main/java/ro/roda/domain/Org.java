...
public class Org {
    ...
    public static void indexOrgs(Collection<Org> orgs) {
        ...
        for (Org org : orgs) {
            ...
            sid.addField("org_solrsummary_t", new StringBuilder().append(org.getOrgPrefixId()).append(" ").append(org.getOrgSufixId()).append(" ").append(org.getShortName()).append(" ").append(org.getFullName()).append(" ").append(org.getId()));
            documents.add(sid);
        }
        try {
