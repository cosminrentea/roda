...
public class InstanceFormController {
	...
	public String create(@Valid InstanceForm instanceForm, BindingResult bindingResult, Model uiModel,
		...
		return "redirect:/instanceforms/"
				+ encodeUrlPathSegment(conversionService.convert(instanceForm.getId(), String.class),
						httpServletRequest);
	}
	...
	public String update(@Valid InstanceForm instanceForm, BindingResult bindingResult, Model uiModel,
			HttpServletRequest httpServletRequest) {
		if (bindingResult.hasErrors()) {
			populateEditForm(uiModel, instanceForm);
	...
	public String delete(@PathVariable("id") InstanceFormPK id,
