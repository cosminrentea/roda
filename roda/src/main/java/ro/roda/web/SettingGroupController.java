...
public class SettingGroupController {
    ...
    public String create(@Valid SettingGroup settingGroup, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
    ...
    public String update(@Valid SettingGroup settingGroup, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
        if (bindingResult.hasErrors()) {
            populateEditForm(uiModel, settingGroup);
