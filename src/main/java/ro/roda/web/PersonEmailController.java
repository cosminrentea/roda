...
public class PersonEmailController {
	...
	public String create(@Valid PersonEmail personEmail, BindingResult bindingResult, Model uiModel,
		...
		return "redirect:/personemails/"
				+ encodeUrlPathSegment(conversionService.convert(personEmail.getId(), String.class), httpServletRequest);
	}
	...
	public String update(@Valid PersonEmail personEmail, BindingResult bindingResult, Model uiModel,
			HttpServletRequest httpServletRequest) {
		if (bindingResult.hasErrors()) {
			populateEditForm(uiModel, personEmail);
	...
	public String delete(@PathVariable("id") PersonEmailPK id,
