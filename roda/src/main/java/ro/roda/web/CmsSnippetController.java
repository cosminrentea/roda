...
public class CmsSnippetController {
    ...
    public String create(@Valid CmsSnippet cmsSnippet, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
    ...
    public String update(@Valid CmsSnippet cmsSnippet, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
        if (bindingResult.hasErrors()) {
            populateEditForm(uiModel, cmsSnippet);
	...
	void populateEditForm(Model uiModel, CmsSnippet cmsSnippet) {
