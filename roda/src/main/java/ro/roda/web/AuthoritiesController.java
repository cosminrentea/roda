...
public class AuthoritiesController {
    ...
    public String create(@Valid Authorities authorities, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
    ...
    public String update(@Valid Authorities authorities, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
        if (bindingResult.hasErrors()) {
            populateEditForm(uiModel, authorities);
    ...
    public String delete(@PathVariable("id") AuthoritiesPK id, @RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model uiModel) {
        Authorities authorities = authoritiesService.findAuthorities(id);
        authoritiesService.deleteAuthorities(authorities);
        uiModel.asMap().clear();
