...
public class PersonAddressController {
	...
	public String create(@Valid PersonAddress personAddress, BindingResult bindingResult, Model uiModel,
		...
		return "redirect:/personaddresses/"
				+ encodeUrlPathSegment(conversionService.convert(personAddress.getId(), String.class),
						httpServletRequest);
	}
	...
	public String update(@Valid PersonAddress personAddress, BindingResult bindingResult, Model uiModel,
			HttpServletRequest httpServletRequest) {
		if (bindingResult.hasErrors()) {
			populateEditForm(uiModel, personAddress);
	...
	public String delete(@PathVariable("id") PersonAddressPK id,
	...
	void addDateTimeFormatPatterns(Model uiModel) {
		uiModel.addAttribute("personAddress_datestart_date_format",
				DateTimeFormat.patternForStyle("M-", LocaleContextHolder.getLocale()));
		uiModel.addAttribute("personAddress_dateend_date_format",
				DateTimeFormat.patternForStyle("M-", LocaleContextHolder.getLocale()));
	}
