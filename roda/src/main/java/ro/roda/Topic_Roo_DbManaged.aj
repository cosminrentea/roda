...
privileged aspect Topic_Roo_DbManaged {
    ...
    @OneToMany(mappedBy = "parentTopicId")
    ...
    @ManyToOne
    @JoinColumn(name = "parent_topic_id", referencedColumnName = "id", insertable = false, updatable = false)
    private Topic Topic.parentTopicId;
    ...
    public Topic Topic.getParentTopicId() {
        return parentTopicId;
    }
    
    public void Topic.setParentTopicId(Topic parentTopicId) {
