...
public class SelectionVariableItemController {
    ...
    public String create(@Valid SelectionVariableItem selectionVariableItem, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
    ...
    public String update(@Valid SelectionVariableItem selectionVariableItem, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
        if (bindingResult.hasErrors()) {
            populateEditForm(uiModel, selectionVariableItem);
    ...
    public String delete(@PathVariable("id") SelectionVariableItemPK id, @RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model uiModel) {
    ...
    public ResponseEntity<String> createFromJsonArray(@RequestBody String json) {
        for (SelectionVariableItem selectionVariableItem: SelectionVariableItem.fromJsonArrayToSelectionVariableItems(json)) {
            selectionVariableItemService.saveSelectionVariableItem(selectionVariableItem);
        }
        HttpHeaders headers = new HttpHeaders();
        headers.add("Content-Type", "application/json");
