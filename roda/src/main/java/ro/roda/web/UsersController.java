...
public class UsersController {
    ...
    @ResponseBody
    public ResponseEntity<String> jsonFindUsersesByUsernameLikeAndEnabled(@RequestParam("username") String username, @RequestParam(value = "enabled", required = false) boolean enabled) {
        HttpHeaders headers = new HttpHeaders();
        headers.add("Content-Type", "application/json; charset=utf-8");
