...
public class CmsFolderController {
	...
	public String create(@Valid CmsFolder cmsFolder, BindingResult bindingResult, Model uiModel,
	...
	public String update(@Valid CmsFolder cmsFolder, BindingResult bindingResult, Model uiModel,
			HttpServletRequest httpServletRequest) {
		if (bindingResult.hasErrors()) {
			populateEditForm(uiModel, cmsFolder);
