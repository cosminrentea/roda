...
public class FormSelectionVarController {
	...
	public String create(@Valid FormSelectionVar formSelectionVar, BindingResult bindingResult, Model uiModel,
		...
		return "redirect:/formselectionvars/"
				+ encodeUrlPathSegment(conversionService.convert(formSelectionVar.getId(), String.class),
						httpServletRequest);
	}
	...
	public String list(@RequestParam(value = "page", required = false) Integer page,
		...
		if (page != null || size != null) {
			...
			uiModel.addAttribute("formselectionvars",
					formSelectionVarService.findFormSelectionVarEntries(firstResult, sizeNo));
	...
	public String update(@Valid FormSelectionVar formSelectionVar, BindingResult bindingResult, Model uiModel,
			HttpServletRequest httpServletRequest) {
		if (bindingResult.hasErrors()) {
			populateEditForm(uiModel, formSelectionVar);
	...
	public String delete(@PathVariable("id") FormSelectionVarPK id,
